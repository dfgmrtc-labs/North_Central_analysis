...
workflow comprehensive {
    ...
    main:
        if (params.run_mode == "without_reads_decontamination"){
            ...
            genome_assembly(genome_assembly_script_wf, trim_fastq.out.trimmed_reads, input_read_type)
...
workflow {
    comprehensive(Channel.value(params.genome_assembly_script), params.se_reads_channel, params.pe_reads_channel,
    Channel.value(params.in_data_type), Channel.value(params.emit_sam_script), Channel.value(params.ref_seq_path_int),
    ...
    Channel.value(params.parse_16S_script), Channel.value(params.perc_cov), Channel.value(params.perc_id), channel.value(params.adp_path_int), Channel.value(params.trim_sample_script))
}
...
workflow kraken_run {
    ...
    main:
        if (params.run_mode == "without_reads_decontamination" | params.in_data_type == "pe_illumina_reads"){
            kraken_contamination(kraken_script_wf, pe_reads_wf, kraken_db_path_wf, input_read_type)
        } else if(params.run_mode == "without_reads_decontamination" | params.in_data_type == "se_illumina_reads"){
            kraken_contamination(kraken_script_wf, se_reads_wf, kraken_db_path_wf, input_read_type)
        }
...
workflow {
    kraken_run(Channel.value(params.kraken_script), params.se_reads_channel, params.pe_reads_channel, Channel.value(params.kraken_db_path),
    Channel.value(params.in_data_type), Channel.value(params.parse_kraken_script))
}
...
/*
workflow {
    comprehensive(Channel.value(params.kraken_script), params.se_reads_channel, params.pe_reads_channel, Channel.value(params.kraken_db_path),
    Channel.value(params.in_data_type), Channel.value(params.emit_sam_script), Channel.value(params.ref_seq_path_int),
    Channel.value(params.coordsort_sam_script), Channel.value(params.bamtofastq_script),
    Channel.value(params.parse_kraken_script))
}
